...
import 'package:grocery_onlineapp/inputFormaters/cardMonthInputFormatter.dart';
import 'package:grocery_onlineapp/inputFormaters/cardNumberInputFormatter.dart';
import 'package:grocery_onlineapp/models/businessLayer/baseRoute.dart';
import 'package:grocery_onlineapp/models/cardModel.dart';
...
import 'package:grocery_onlineapp/screens/stripe_payment_screen.dart';
                        ...
                        ? RadioListTile(
                            ...
                            onChanged: (val) async {
                              ...
                              if (global.userProfileController.currentUser.wallet >= totalAmount) {
                                ...
                                // } else {
                                //   order.remPrice = totalAmount - global.userProfileController.currentUser.wallet;
                                // }
