  ...
  _init() async {
    try {
      ...
      if (global.userProfileController.currentUser != null && global.userProfileController.addressList != null && global.userProfileController.addressList.length > 0) {
        await _getSociety(global.userProfileController.addressList[0].cityId, false);
        _selectedCity = _citiesList.firstWhere((e) => e.cityId == global.userProfileController.addressList[0].cityId);
        _cCity.text = _selectedCity.cityName;
        _selectedSociety = _societyList.firstWhere((e) => e.societyId == global.userProfileController.addressList[0].societyId);
