...
import 'package:grocery_onlineapp/screens/productlist_screen.dart';
import 'package:grocery_onlineapp/screens/ratingListScreen.dart';
                                    ...
                                    return PhotoViewGalleryPageOptions(
                                        imageProvider: _productDetail.productDetail.images != null && _productDetail.productDetail.images.length > 0
                                            ...
                                            : _productDetail.productDetail.productImage != null
                                                ...
                                                : Container(width: screenWidth, height: 260, child: Image.asset('assets/images/appicon_180x180.png')));
                                  },
                  ...
                  ? InkWell(
                      onTap: () async {
                        if (global.currentUser.id == null) {
                          ...
                          bool isSuccess = await value.addToCart(_productDetail.productDetail, _qty, false, varient: _productDetail.productDetail.varient[i]);
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              ...
                              showOnlyLoaderDialog();
                              bool isSuccess = await value.addToCart(_productDetail.productDetail, _qty, true, varient: _productDetail.productDetail.varient[i]);
                              if (isSuccess != null) {
                                Navigator.of(context).pop();
                              }
                              setState(() {});
